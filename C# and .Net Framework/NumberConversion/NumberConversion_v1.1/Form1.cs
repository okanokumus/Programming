...
namespace NumberConversion_v._1._0
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            switch (tabDefinition)
            {
                ...
                #region Trigonometric Transformation
                case "TrigonometricTransformation":
                    try
                    {
                    }
                    catch (Exception)
        ...
        // from radians to degrees convertor
        void radiansTOdegrees()
        {
            // only digit numbers can be accepted
            rad = Convert.ToDouble(textBox5.Text);
            deg = Convert.ToDouble(textBox6.Text);
            // degree to radian
            if (deg != 0)
            {
                rad = (deg *  pi) / 180;
